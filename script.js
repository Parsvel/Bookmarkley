...
function startTabBrowser () {
  document.body.innerHTML = '<iframe id="bkVCPiFrame" src="https://void.cubestudios.ml" sandbox="allow-scripts allow-popups allow-same-origin" style="width:100%;height:100%" title="Iframe Example"></iframe>'
}
